...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-08 09:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/da1c2fbf-ed10-4c09-a11b-0c5544b72e9f.git
$ cd da1c2fbf-ed10-4c09-a11b-0c5544b72e9f
```
